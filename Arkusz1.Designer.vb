...
Partial Public NotInheritable Class Arkusz1
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Arkusz1", "Arkusz1")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Arkusz1 As Arkusz1
    
    Friend Shared Property Arkusz1() As Arkusz1
        Get
            Return _Arkusz1
        End Get
        Set
            If (_Arkusz1 Is Nothing) Then
                _Arkusz1 = value
            Else
